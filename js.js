...
document.addEventListener("DOMContentLoaded", () => {
  fetch("./providerData.json")
    ...
    .then((data) => {
      ...
      rows.forEach((row) => {
        // Change the row color depending on address
        ...
        cells.forEach((cell) => {
          if (cell.textContent === "7734 N 59th Ave Glendale AZ 85301") {
            ...
            cell.textContent === "4250 W Baseline Rd Laveen, AZ 85339"
          ) {
            hasLaveen = true;
            return;
          } else if (
            cell.textContent === "616 E Southern Ave Ste 103,Mesa AZ 85204"
          ) {
            hasMesa = true;
            return;
          } else if (
            cell.textContent ===
            "15235 N Dysart Rd Ste 103, El Mirage, AZ 85335"
          ) {
            hasElMirage = true;
            return;
            ...
            cell.textContent === "1533 E Willetta St Phoenix AZ 85006"
          ) {
            hasCentro = true;
            return;
          } else if (
            cell.textContent === "301 E Cottonwood Ln Casa Grande AZ 85122"
          ) {
            hasCasaGrande = true;
            return;
          } else if (
            cell.textContent === "1315 W Southern Ave Tempe, AZ 85282"
          ) {
            hasTempe = true;
            return;
